...
return (
            <div className='relative mx-auto w-full max-w-2xl rounded-xl overflow-hidden isolate'>
            <div className={`relative ${aspectClasses[aspectRatio]}`}>
            {/* loading state */}
            {isLoading && (
                <div className='absolute inset-0 rounded-xl flex flex-col items-center
justify-center gap-4 border-2 border-dashed border-white/20 bg-black/25'>
